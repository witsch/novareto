...
def setup_product():
    ...
    import nva.moderatorenliste
    zcml.load_config('configure.zcml', nva.moderatorenliste)
    ...
    ztc.installPackage('nva.moderatorenliste')
...
setup_product()
ptc.setupPloneSite(products=['nva.moderatorenliste'])
