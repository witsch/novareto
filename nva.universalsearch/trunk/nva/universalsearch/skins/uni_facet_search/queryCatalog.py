...
##parameters=REQUEST=None,show_all=0,quote_logic=0,quote_logic_indexes=['system', 'SearchableText','Description','Title'],use_types_blacklist=False,show_inactive=False,use_navigation_root=False
