...
BewerberSchema = schemata.ATContentTypeSchema.copy() + atapi.Schema((
    ...
    atapi.DateTimeField(
        ...
        widget=atapi.CalendarWidget(            label=_(u"Besuchsbeginn (Termin)"),
            description=_(u"Tragen Sie den vereinbarten Bessuchsbeginn ein oder klicken Sie auf das Kalender-Icon und treffen eine A
uswahl."),
        ),
        required=True,
    ...
    atapi.DateTimeField(
        ...
        widget=atapi.CalendarWidget(            label=_(u"Besuchsende (Termin)"),
            description=_(u"Tragen Sie das vereinbarte Besuchsende ein oder klicken Sie auf das Kalender-Icon und treffen eine Auswa
hl."),
        ),
        required=True,
        validators=('isValidDate'),
