...
def setup_product():
    ...
    import nva.webcodeproxy
    zcml.load_config('configure.zcml', nva.webcodeproxy)
    ...
    ztc.installPackage('nva.webcodeproxy')
...
setup_product()
ptc.setupPloneSite(products=['nva.webcodeproxy'])
